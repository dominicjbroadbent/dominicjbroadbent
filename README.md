...
Bilateral Distribution Compression: Reducing Both Data Size and Dimensionality - [Under review at ICML 2026](https://arxiv.org/abs/2509.17543), this work extends distribution compression to also consider dimension reduction. We reduce both the number of observations adn the number of dimensions of a dataset simultaneously while maintaing or improving downstream task performance for datasets which exhibit low-dimensional manifold structure.
